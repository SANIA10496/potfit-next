...
//double Splines::splint_ed(pot_table_t *pt, double *xi, int col, double r)
//{
...
//double Splines::splint_comb_ed(pot_table_t *pt, double *xi, int col, double r, double *grad)
//{
//  double a, b, istep, rr, p1, p2, d21, d22;
//  int   k;
...
//double Splines::splint_grad_ed(pot_table_t *pt, double *xi, int col, double r)
//{
//  double a, b, istep, rr, p1, p2, d21, d22;
//  int   k;
...
//double Splines::splint_grad_dir(pot_table_t *pt, double *xi, int k, double b, double step)
//{
//  double a, p1, p2, d21, d22;
...
//double Splines::splint_ne(pot_table_t *pt, double *xi, int col, double r)
//{
//  int   klo, khi, k;
...
//double Splines::splint_comb_ne(pot_table_t *pt, double *xi, int col, double r, double *grad)
//{
//  int   klo, khi, k;
//  double h, b, a, d22, d21, p1, p2, x1, x2;
...
//double Splines::splint_grad_ne(pot_table_t *pt, double *xi, int col, double r)
//{
//  int   klo, khi, k;
//  double h, b, a, d22, d21, p1, p2, x1, x2;
